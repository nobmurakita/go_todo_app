...
import (
	...
	"github.com/nobmurakita/go_todo_app/clock"
	"github.com/nobmurakita/go_todo_app/entity"
	"github.com/nobmurakita/go_todo_app/testutil"
	"github.com/nobmurakita/go_todo_app/testutil/fixture"
)
...
func prepareUsers(ctx context.Context, t *testing.T, db Execer) entity.UserID {
	t.Helper()
	u := fixture.User(nil)
...
func prepareTasks(ctx context.Context, t *testing.T, con Execer) (entity.UserID, entity.Tasks) {
	t.Helper()
	userID := prepareUsers(ctx, t, con)
	otherUserID := prepareUsers(ctx, t, con)
